...
public struct Option<T, TException> : IEquatable<Option<T, TException>>, IComparable<Option<T, TException>>
{
    ...
    public override string ToString()
    {
        if (hasValue)
        {
            ...
            return string.Format(System.Globalization.CultureInfo.InvariantCulture, "Some({0})", value);
        }
        ...
        return string.Format(System.Globalization.CultureInfo.InvariantCulture, "None({0})", exception);
    }
